                ...
                <form action="<?php echo base_url("portfolio/save"); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" placeholder="Ürünün ismi" name="name"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Üründen kaç adet giriceksiniz ? " name="count"
                                        value="<?php echo isset($form_error) ? set_value("count") : ""; ?>">
                                        <?php if(isset($form_error)){ ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Ürünün Fiyatı" name="price"
